...
local
   ...
   Partition1 = [Tune End1 Tune End2 Interlude Tune End2]
   Partition2 = [End1 Tune End2 Interlude Tune End2 Tune]
in
   % Ceci est une musique :-)
   [merge( [ 0.5#[partition(Partition1)] 0.5#[partition(Partition2)] ] )]
end